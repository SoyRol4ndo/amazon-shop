...
import { ProductActions } from "@/src/features/products/components/ProductActions";
...
export async function ProductDetailPage({ id }: ProductDetailPageProps) {
  ...
  try {
    ...
    return (
      <div className="container mx-auto px-4 py-24 flex flex-col items-center text-gray-400">
